...
gulp.task('watch', function()
{
	...
	gulp.watch("src/assets/img/*", gulp.parallel(() => { browserSync.reload() }));
	gulp.watch("src/assets/svg/*", gulp.parallel('svg-min'));
	gulp.watch("src/assets/svg/*", gulp.parallel(() => { browserSync.reload() }));
});
...
gulp.task('default', gulp.parallel('watch', 'browser-sync', 'sass', 'twig', 'svg-min', 'img', 'scripts', () => { console.log('dev start');}));